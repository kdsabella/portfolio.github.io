...
// Navigation active on page scroll
...
const getCurrentTheme = () => document.classList.contains("dark-theme") ? "dark" : "light";
const getCurrentIcon = () => document.classList.contains("sun") ? "sub" : "moon";
